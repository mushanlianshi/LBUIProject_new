...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BLTAlertEventQueue/BLTAlertEventQueue.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BLTBasicUIKit/BLTBasicUIKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BLTSwiftUIKit/BLTSwiftUIKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BLTUIKitProject/BLTUIKitProject.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/DSScrollKit/DSScrollKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/JPSuspensionEntrance/JPSuspensionEntrance.framework"
