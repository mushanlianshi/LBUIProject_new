...
@property (nonatomic, assign) NSTextAlignment labelAlignment;     //当文字长度未超过Frame宽度时的对齐方式：左，中，右。默认为居中对齐。
...
@property (nonatomic, assign) BOOL autoBeginScroll;                     //是否自动开始滚动，默认为NO
