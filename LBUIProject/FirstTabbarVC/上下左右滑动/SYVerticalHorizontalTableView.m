...
{
    if (scrollView == self) {
        NSLog(@"LBLog scrollview is self -----------");
    }else if (scrollView == self.tableLeft){
        NSLog(@"LBLog scrollview is tableLeft -----------");
    }else if (scrollView == self.scrollRight){
        NSLog(@"LBLog scrollview is scrollRight -----------");
    }else if (scrollView == self.tableRight){
        NSLog(@"LBLog scrollview is tableRight -----------");
    }
...
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate
{
    ...
    NSLog(@"LBlog scrollview %@ , %@ , %@",@(self.frame), @(self.contentOffset), @(self.contentSize));
    NSLog(@"LBlog tableLeft %@ , %@, %@",@(self.tableLeft.frame), @(self.tableLeft.contentOffset), @(self.tableLeft.contentSize));
    NSLog(@"LBlog tableRight %@ , %@ , %@",@(self.tableRight.frame), @(self.tableRight.contentOffset), @(self.tableRight.contentSize));
    NSLog(@"LBlog scrollRight %@ , %@ , %@",@(self.scrollRight.frame), @(self.scrollRight.contentOffset), @(self.scrollRight.contentSize));
...
//    NSLog(@"lblog  layoutSubviews =====");
//    NSLog(@"lblog  layoutSubviews tableLeft.frame %@",@(self.tableLeft.frame));
//    NSLog(@"lblog  layoutSubviews scrollRight.frame %@",@(self.scrollRight.frame));
}
